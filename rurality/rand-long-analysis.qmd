...
rlf_dd <- rlf %>%
    ...
    mutate( # semantic recodes
        # all these variables have .-prefixed missing values, rendered correctly by default
        across(GENDER, ~recode(.x, 
            '1' = 'Male', 
            '2' = 'Female')), 
        across(RACE, ~recode(.x, 
            '1' = 'White', 
            '2' = 'Black', 
            '3' = 'Other')), 
        across(HISP, ~recode(.x, 
            '0' = 'Not Hispanic', 
            '1' = 'Hispanic')), 
        across(REGION, ~recode(.x, 
            '1' = 'Northeast', 
            '2' = 'Midwest', 
            '3' = 'South', 
            '4' = 'West', 
            '5' = 'Other')), 
        across(RURAL, ~recode(.x, 
            '1' = 'Urban', 
            '2' = 'Suburban', 
            '3' = 'Rural')), 
        across(HLTH_CHNG, ~recode(.x, 
            '1' = 'Better', 
            '2' = 'Same', 
            '3' = 'Worse')), 
        across(HLTH_CHNG, ~recode(.x, 
