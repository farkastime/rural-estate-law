...
# Step 1: File paths
Chaves_path <- "/Users/sophierane/Library/CloudStorage/OneDrive-UniversityofNewMexico/Rural Estate Planning Fellowship Research/NM Probate Research/Decedents/CSV Data Files/2015 Chaves Probate Data.xlsx"
Colfax_path <- "/Users/sophierane/Library/CloudStorage/OneDrive-UniversityofNewMexico/Rural Estate Planning Fellowship Research/NM Probate Research/Decedents/CSV Data Files/2015 Colfax Probate Data.xlsx"
Cibola_path <- "/Users/sophierane/Library/CloudStorage/OneDrive-UniversityofNewMexico/Rural Estate Planning Fellowship Research/NM Probate Research/Decedents/CSV Data Files/2015 Cibola Probate Data.xlsx"
...
master2015 <- master2015 |>
  mutate(
    ...
    Executed_Within_3_Years = Will_Age <= 1095,
...
master2015 <- master2015 |>
  mutate(
    Filing_Date = as.Date(Filing_Date, format = "%m/%d/%Y"),
    Closed_Date = as.Date(Closed_Date, format = "%m/%d/%Y"),
